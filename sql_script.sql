CREATE TYPE "public"."language" AS ENUM('cs', 'en', 'de');--> statement-breakpoint
CREATE TYPE "public"."registration_status" AS ENUM('pending', 'confirmed', 'cancelled', 'rejected');--> statement-breakpoint
CREATE TYPE "public"."token_transaction_type" AS ENUM('purchase', 'reward', 'donation', 'payment', 'refund');--> statement-breakpoint
CREATE TYPE "public"."tournament_format" AS ENUM('knockout', 'groups', 'round_robin', 'swiss', 'league', 'custom');--> statement-breakpoint
CREATE TYPE "public"."tournament_status" AS ENUM('created', 'registration_open', 'registration_closed', 'in_progress', 'completed', 'cancelled');--> statement-breakpoint
...
ALTER TABLE "matches" ADD CONSTRAINT "matches_phase_id_tournament_phases_id_fk" FOREIGN KEY ("phase_id") REFERENCES "public"."tournament_phases"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "sport_translations" ADD CONSTRAINT "sport_translations_sport_id_sports_id_fk" FOREIGN KEY ("sport_id") REFERENCES "public"."sports"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "token_transactions" ADD CONSTRAINT "token_transactions_from_wallet_id_token_wallets_id_fk" FOREIGN KEY ("from_wallet_id") REFERENCES "public"."token_wallets"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "token_transactions" ADD CONSTRAINT "token_transactions_to_wallet_id_token_wallets_id_fk" FOREIGN KEY ("to_wallet_id") REFERENCES "public"."token_wallets"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "token_transactions" ADD CONSTRAINT "token_transactions_tournament_id_tournaments_id_fk" FOREIGN KEY ("tournament_id") REFERENCES "public"."tournaments"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "token_transactions" ADD CONSTRAINT "token_transactions_match_id_matches_id_fk" FOREIGN KEY ("match_id") REFERENCES "public"."matches"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "tournament_translations" ADD CONSTRAINT "tournament_translations_tournament_id_tournaments_id_fk" FOREIGN KEY ("tournament_id") REFERENCES "public"."tournaments"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "tournaments" ADD CONSTRAINT "tournaments_organizer_id_organizers_id_fk" FOREIGN KEY ("organizer_id") REFERENCES "public"."organizers"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
